...
exports.addWhoAreWeData = async (req, res, next) => {
  try {
    ...
    res.status(200).send({ message: messages_en.who_are_we_added_successfully, data: result });
  } catch (err) {
...
exports.getWhoAreWeDataById = async (req, res, next) => {
  ...
  try {
    ...
    if (!data) {
      return res.status(404).send({ message: messages_en.who_are_we_not_found });
    }
...
exports.updateWhoAreWeData = async (req, res, next) => {
  ...
  try {
    ...
    res.status(200).send({ message: messages_en.who_are_we_updated_successfully, data: updatedData });
  } catch (err) {
...
exports.deleteWhoAreWeData = async (req, res, next) => {
  ...
  try {
    ...
    res.status(200).send({ message: messages_en.who_are_we_deleted_successfully });
  } catch (err) {
