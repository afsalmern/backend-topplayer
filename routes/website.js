...
router.post("/video", [authMiddleware.checkUserAuth], websiteController.watchVideo);
router.get("/video/:videoId/:courseId/:token", websiteController.getVideo);
router.get("/videos/:courseId/:subCourseId/:day", [authMiddleware.checkUserAuth], websiteController.getVideos);
