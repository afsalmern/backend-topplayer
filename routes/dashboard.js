...
router.post("/course", [authMiddleware.checkUserAuth], courseController.addCourse);

router.get("/course", [authMiddleware.checkUserAuth], courseController.getAllCourses);

router.put("/course/:id", [authMiddleware.checkUserAuth], courseController.updateCourse);
